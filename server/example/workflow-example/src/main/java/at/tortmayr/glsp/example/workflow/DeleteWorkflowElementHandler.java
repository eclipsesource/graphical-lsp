...
public class DeleteWorkflowElementHandler implements OperationHandler {
	...
	private void delete(SModelElement element, GraphicalModelState modelState) {
	...
	private SModelElement findNode(SModelElement element, SModelIndex index) {
